...
objCommand.CommandText = _
    "Select Name, Location from 'LDAP://ou=students,ou=mc users,DC=manchester,DC=edu' " _
...
Do Until objRecordSet.EOF
    ...
    textFile.WriteLine(objRecordSet.Fields("Name").Value) & "@spartans.manchester.edu"
