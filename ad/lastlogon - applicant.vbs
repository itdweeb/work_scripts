...
Set objFile = objFSO.OpenTextFile (strFilePath & "\Applicant Last Logon " & strLDate & ".csv",ForAppending,True)
...
'*******************************************************************
  ...
  objCommand.CommandText = "<LDAP://" & sDCs(k) & "/ou=applicants,dc=manchester,dc=edu" & ">;(ObjectCategory=User);Name,LastLogon,givenName,sn;subtree"
