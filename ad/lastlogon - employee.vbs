...
Set objFile = objFSO.OpenTextFile (strFilePath & "\Employee Last Logon " & strLDate & ".csv",ForAppending,True)
...
'*******************************************************************
  ...
  objCommand.CommandText = "<LDAP://" & sDCs(k) & "/ou=employees,ou=mc users,dc=manchester,dc=edu" & ">;(ObjectCategory=User);Name,LastLogon,givenName,sn;subtree"
