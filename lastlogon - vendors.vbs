...
Set objFile = objFSO.OpenTextFile (strFilePath & "\Vendor Last Logon " & strLDate & ".csv",ForAppending,True)
...
'*******************************************************************
  ...
  objCommand.CommandText = "<LDAP://" & sDCs(k) & "/ou=vendors,dc=manchester,dc=edu" & ">;(ObjectCategory=User);Name,LastLogon,givenName,sn;subtree"
